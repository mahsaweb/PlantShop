...
const Hero = () => {
  return (
    <section className="relative w-full h-screen bg-[url('/assets/Images/hero-bg.webp')] bg-cover object-cover">
      <div className="w-full h-full pt-20 flex items-center px-6 md:px-20 bg-linear-to-r from-emerald-950/90 via-emerald-950/70 to-transparent">
        <div className="max-w-7xl mx-auto w-full">
          ...
          <button className="w-fit font-semibold uppercase tracking-wider mt-10 px-8 py-3.5 rounded-lg bg-emerald-500 text-emerald-50 hover:bg-emerald-600 transition-all duration-300 active:scale-95">
            View Products
          </button>
        </div>
      </div>
